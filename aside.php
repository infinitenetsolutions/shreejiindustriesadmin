...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <!-- Brand Logo -->
  <a href="index.php" class="brand-link" style="background: #f4f6f9;">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="./pages/enquiry/" class="nav-link active">
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="./pages/categries/categories.php" class="nav-link active">
                <i class="far fa-circle nav-icon"></i>
                <p>Categories</p>
              </a>
            </li>
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="./pages/product/product.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Product</p>
              </a>
            </li>
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="./pages/about/about.php" class="nav-link"> <i class="far fa-circle nav-icon"></i>
                <p>About Company</p>
              </a>
            </li>
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="./pages/about/about-director.php" class="nav-link"> <i class="far fa-circle nav-icon"></i>
                <p>About Director</p>
              </a>
            </li>
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="./pages/jobtype" class="nav-link"> <i class="far fa-circle nav-icon"></i>
                <p>Job</p>
              </a>
            </li>
        ...
        <li class="nav-item has-treeview">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="./pages/testimonial" class="nav-link"> <i class="far fa-circle nav-icon"></i>
                <p>Testimonial</p>
              </a>
            </li>
