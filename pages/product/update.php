              ...
              <div class="container">
                <div class="row">
                  ...
                  <div class="form-group col-sm-4">
                    ...
                    <input value="<?php echo $product_name ?>" name="name" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter product Name">
                  </div>

                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">PRODUCT CODE</label>
                    <input value="<?php echo $p_code ?>" name="p_code" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product code">


                  </div>
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">PRODUCT BOOKING AMOUNT (IN <i class="fas fa-rupee-sign    "></i> )</label>
                    <input value="<?php echo $p_short_desc ?>" name="p_short_desc" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Booking amount">
                  </div>
                  
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">MODEL NO</label>
                    <input value="<?php echo $model_no ?>" name="p_model_no" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Model no">


                  </div>
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">Brand</label>
                    <input value="<?php echo $make ?>" name="make" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Brand">


                  </div>
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">GRADE</label>
                    <input value="<?php echo $grade ?>" name="grade" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Grade ">
                  </div>
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">MATERIAL TYPE</label>
                    <input value="<?php echo $materialtype ?>" name="materialtype" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Material Type">

                  </div>

                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">SIZE</label>
                    <input value="<?php echo $size ?>" name="size" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Size">


                  </div>
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">CONVEYOR WIDTH</label>
                    <input value="<?php echo $con_width ?>" name="con_width" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Conveyor Width">


                  </div>
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">Thickness</label>
                    <input value="<?php echo $thickness ?>" name="thickness" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Thickness">
                  </div>


                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">CYLINDER SIZE</label>
                    <input value="<?php echo $cylinder_size ?>" name="cylinder_size" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Cylinder Size">
                  ...
                  <div class="form-group col-sm-4">
                    ...
                    <input value="<?php echo $pressure ?>" name="pressure" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Pressure">
                  ...
                  <div class="form-group col-sm-4">
                    ...
                    <input value="<?php echo $heating ?>" name="heating" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Heating Area">
                  ...
                  <div class="form-group col-sm-4">
                    ...
                    <input value="<?php echo $pack_type ?>" name="pack_type" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Packing Type">
                  ...
                  <div class="form-group col-sm-4">
                    ...
                    <input value="<?php echo $pack_accuracy ?>" name="pack_accuracy" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Packing Accuracy">
                  ...
                  <div class="form-group col-sm-4">
                    ...
                    <input value="<?php echo $seal_time ?>" name="seal_time" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Sealing Time">
                  ...
                  <div class="form-group col-sm-4">
                    ...
                    <input value="<?php echo $production_rete ?>" name="production_rete" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Production Rate">


                  </div>
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">FOOD CONTACT BODY</label>
                    <input value="<?php echo $food_con_body ?>" name="food_con_body" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Food Contact Body">


                  </div>
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">FRAME BODY</label>
                    <input value="<?php echo $p_categries_name ?>" name="frame_body" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Frame Body">


                  </div>
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">MOTOR</label>
                    <input value="<?php echo $motor ?>" name="motor" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Motor">
                  </div>


                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">POWER REQUIREMENT</label>
                    <input value="<?php echo $p_categries_name ?>" name="power_require" type="text" class="form-control" id="exampleFormControlSelect1" maplaceholder="Enter product Power Requirement">


                  </div>
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">POWER CONSUMPTION</label>
                    <input value="<?php echo $power_consumption ?>" name="power_consumption" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Power Consumption">


                  </div>
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">POWER SUPPLY</label>
                    <input value="<?php echo $power_supply ?>" name="power_supply" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Power Supply">


                  </div>
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">TEMPERATURE</label>
                    <input value="<?php echo $temperature ?>" name="temperature" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Temperature">
                  ...
                  <div class="form-group col-sm-4">
                    ...
                    <input value="<?php echo $machine_size ?>" name="machine_size" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Machine Size">


                  </div>
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">WEIGHT</label>
                    <input value="<?php echo $weight ?>" name="weight" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter product Weight ">
                  ...
                  <div class="form-group col-sm-4">
                    ...
                    <input value="<?php echo $space ?>" name="space" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Space Required">


                  </div>
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">MAN POWER </label>
                    <input value="<?php echo $man_power ?>" name="man_power" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Man Power">


                  </div>
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">WARRANTY</label>
                    <input value="<?php echo $p_item_warranty ?>" name="p_item_warranty" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter product Warranty">
                  </div>

                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">ORIGIN COUNTRY</label>
                    <input value="<?php echo $p_origin_country ?>" name="p_origin_country" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter the Country of the Product ">
                  </div>

                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">DESCRIPTION</label>
                    <textarea name="p_long_desc" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Description">
                    <?php echo $product_description ?>
                  </textarea>
                  </div>
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">Product meta title</label>
                    <input value="<?php echo $p_mete_title ?>" name="p_mete_title" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Meta title ">
                  </div>

                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">Extra meta Description </label>
                    <input value="<?php echo $p_meta_desc ?>" name="p_meta_desc" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter meta Descrtption">
                  </div>
                  <div class="form-group col-sm-4">
                    <label class="a-color" for="exampleFormControlSelect1">Enter keyword of the product </label>
                    <input value="<?php echo $p_meta_keyword ?>" name="p_meta_keyword" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Keyword of the product">
                  </div>
                  <div class="form-group col-sm-4">
