...
if (isset($_POST['add'])) {
  ...
  if ($cat != '') {
    ...
    if ($p_result) {
      ...
      $booking = " INSERT INTO `booking`(`payment`, `delivery_time`, `policy`, `ability`, `avaible`, `details`, `market`, `product_id`) VALUES 
                              ('Cash Advance (CA)','5 - 6 Days','	Contact us for information regarding our sample policy',' ','Yes','	as per requirement','All India','$pro_id')";
      $res = mysqli_query($connection, $booking);
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="form-group col-sm-4">
                ...
                <input name="make" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Brand">


              </div>
              <div class="form-group col-sm-4">
                <label class="a-color" for="exampleFormControlSelect1">GRADE</label>
                <input name="grade" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Grade ">
              </div>
              <div class="form-group col-sm-4">
                <label class="a-color" for="exampleFormControlSelect1">MATERIAL TYPE</label>
                <input name="materialtype" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Material Type">

              </div>

              <div class="form-group col-sm-4">
                <label class="a-color" for="exampleFormControlSelect1">SIZE</label>
                <input name="size" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Size">


              </div>
              <div class="form-group col-sm-4">
                <label class="a-color" for="exampleFormControlSelect1">CONVEYOR WIDTH</label>
                <input name="con_width" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Conveyor Width">
              ...
              <div class="form-group col-sm-4">
                ...
                <input name="cylinder_size" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Cylinder Size">
              ...
              <div class="form-group col-sm-4">
                ...
                <input name="pressure" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Pressure">
              ...
              <div class="form-group col-sm-4">
                ...
                <input name="heating" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Heating Area">
              ...
              <div class="form-group col-sm-4">
                ...
                <input name="pack_type" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Packing Size">
              ...
              <div class="form-group col-sm-4">
                ...
                <input name="pack_accuracy" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Packing Accuracy">
              ...
              <div class="form-group col-sm-4">
                ...
                <input name="seal_time" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Sealing Time">
              ...
              <div class="form-group col-sm-4">
                ...
                <input name="production_rete" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Production Rate">


              </div>
              <div class="form-group col-sm-4">
                <label class="a-color" for="exampleFormControlSelect1">FOOD CONTACT BODY</label>
                <input name="food_con_body" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Food Contact Body">


              </div>
              <div class="form-group col-sm-4">
                <label class="a-color" for="exampleFormControlSelect1">FRAME BODY</label>
                <input name="frame_body" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Frame Body">


              </div>
              <div class="form-group col-sm-4">
                <label class="a-color" for="exampleFormControlSelect1">MOTOR</label>
                <input name="motor" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Motor">
              </div>


              <div class="form-group col-sm-4">
                <label class="a-color" for="exampleFormControlSelect1">POWER REQUIREMENT</label>
                <input name="power_require" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Power Requirement">


              </div>
              <div class="form-group col-sm-4">
                <label class="a-color" for="exampleFormControlSelect1">POWER CONSUMPTION</label>
                <input name="power_consumption" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Power Consumption">


              </div>
              <div class="form-group col-sm-4">
                <label class="a-color" for="exampleFormControlSelect1">POWER SUPPLY</label>
                <input name="power_supply" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Power Supply">


              </div>
              <div class="form-group col-sm-4">
                <label class="a-color" for="exampleFormControlSelect1">TEMPERATURE</label>
                <input name="temperature" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Temperature">
              ...
              <div class="form-group col-sm-4">
                ...
                <input name="machine_size" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Machine Size">


              </div>
              <div class="form-group col-sm-4">
                <label class="a-color" for="exampleFormControlSelect1">WEIGHT</label>
                <input name="weight" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Weight">
              ...
              <div class="form-group col-sm-4">
                ...
                <input name="space" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Product Space Required">
              ...
              <div class="form-group col-sm-4">
                ...
                <input name="p_item_warranty" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter product Warranty">
              </div>

              <div class="form-group col-sm-4">
                <label class="a-color" for="exampleFormControlSelect1">ORIGIN COUNTRY</label>
                <input name="p_origin_country" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter the Origin Country of the Product ">
              </div>

              <div class="form-group col-sm-4">
                <label class="a-color" for="exampleFormControlSelect1">DESCRIPTION</label>
                <textarea name="p_long_desc" type="text" class="form-control" id="exampleFormControlSelect1" placeholder="Enter Description of the product"></textarea>
              </div>
              <div class="form-group col-sm-4">
