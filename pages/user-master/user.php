                    ...
                    <tbody>
                      ...
                      ?>
                          <tr>
                            ...
                            <td> <a href="../mailbox/read-mail.php?read=<?php echo $rows['con_id']; ?>" >Read..</a></td>
                            <td> <?php
                                  if ($rows['con_status'] == 1) {
                                    echo "<a class='btn btn-success' href='activedeactive.php?type=status&operation=deactive&id=" . $rows['con_id'] . "'>Active</a>";
                                  } else {
                                    echo "<a class='btn btn-secondary' href='activedeactive.php?type=status&operation=active&id=" . $rows['con_id'] . "'>Deactive</a>";
                                  }

                                  ?>
                            </td>
                            <td> <a href="delete.php?delete=<?php echo $rows['con_id']; ?>" class="btn btn-danger">Delete</a></td>
