            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                  <a href="" class="btn btn-primary text-center" data-toggle="modal" data-target="#insert">Add new Slider
                  </a>
                      ...
                      <tbody>
                        ...
                        if (mysqli_num_rows($imageresult) > 0) {
                          while ($rowimage = mysqli_fetch_array($imageresult)) {
                            ...
                            $catname = "SELECT * FROM `categories` WHERE `c_id`=$ci_id";
                            $cat = mysqli_query($connection, $catname);
                        ...
                        ?>
                            <tr>
                              ...
                              <img height="30px" width="30px" <?php echo ' src="data:image/jpeg;base64,' . base64_encode($rowimage['ci_images']) . '"' ?> class="img-fluid mb-2" alt="Slider Images" />
                              </a>
                              </td>
                              <td><a href="update.php?edit=<?php echo $rowimage['ci_id']; ?>" class="btn btn-warning">Update</a></td>
                              <td> <a href="delete.php?delete=<?php echo $rowimage['ci_id']; ?>" class="btn btn-danger">Delete</a>
                              <td> <?php
